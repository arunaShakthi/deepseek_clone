    ...
    ${expand ? 'p-4 w-64' : 'md:w-20 w-0'}`}>
        <div>
            ...
            <div>
                <button className={`mt-8 flex items-center justify-center cursor-pointer 
                    ...
                    transition bg-black text-white text-sm px-3 py-2 rounded-lg pointer-events-none'>
                        New chat
        ...
        <div>
            ...
            'h-10 w-10 mx-auto hover:bg-gray-500/30 rounded-lg'}`}>
                ...
                <div className={`absolute -top-60 pb-8 ${!expand && '-right-40'} opacity-0 
            ...
            <div onClick={user ? null : openSignIn} className={`flex items-center ${expand ? 'hover:bg-white/10 rounded-lg' : 'justify-center w-full'}
